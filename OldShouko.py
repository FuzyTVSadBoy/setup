...
local FILE = "heartbeat_" .. UID .. ".txt"

-- Kiểm tra hàm writefile
if not writefile then
    warn("[SHOUKO] Executor không hỗ trợ writefile!")
    return
end
...
Player.OnTeleport:Connect(function()
    update("TELEPORT")
    -- Đợi 15s để xem có bị kẹt không
    task.wait(15)
